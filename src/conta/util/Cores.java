...
public class Cores {
	...
	//Reset Color
	public static final String TEXT_RESET = "\u001B[0m"; //O nome da variável está em maiúsculo por se tratar de uma constante, ou seja, o valor não pode ser modificado.
	...
	//Texto normal com cor intensa/iluminada
	...
	//Texto NEGRITO com cor intensa/iluminada
	...
	//Cor de Fundo com alta intensidade
